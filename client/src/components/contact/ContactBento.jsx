export default function ContactBento() {
  return (
    <section className="grid grid-cols-1 items-stretch gap-6 px-2 sm:px-4 md:grid-cols-2 md:px-8 lg:grid-cols-3 lg:px-16">
      <article className="border-bsi-outline/20 bg-bsi-surface-lowest h-full rounded-xl border p-6 shadow-[0_20px_40px_rgba(0,32,69,0.02)] md:p-8">
      ...
      <article className="bg-bsi-primary-container relative h-full overflow-hidden rounded-xl p-8 text-white">
      ...
      <article className="border-bsi-outline/20 bg-bsi-surface-low flex h-full flex-col overflow-hidden rounded-xl border">
        ...
        <div className="relative flex flex-1 items-center justify-center bg-slate-100 min-h-52 sm:min-h-60">
