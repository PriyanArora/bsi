export default function AboutHero() {
  return (
    <header className="-mt-1 mb-14 max-w-4xl pl-2 sm:-mt-2 sm:mb-16 sm:pl-4 md:mt-8 md:mb-20 md:pl-8 lg:mt-10 lg:pl-16">
      ...
      <p className="text-bsi-secondary max-w-2xl text-base leading-relaxed sm:text-lg">
        As an authorized Bajaj Indef dealer, BSI Solutionz has defined the standard for industrial lifting and material
        handling for over two decades.
      </p>
    </header>
  )
}
